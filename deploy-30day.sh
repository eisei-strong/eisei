...
scp /Users/kodai/eisei/30day_kirigaeshi.html "$REMOTE:$BASE/30day/kirigaeshi.html"
scp /Users/kodai/eisei/ai_kirigaeshi_data.json "$REMOTE:$BASE/30day/ai_kirigaeshi_data.json"
...
echo "  切り返しマスター(AI): https://giver.work/30day/kirigaeshi.html"
